...
def show_classimage(Train,c,cname):
    ...
    fpath0= "D:\\Sem6\\miniproject\\project\\DeepRetinopathy\\dbase\\"+ cls['image'].iloc[0] +".jpeg" 
    fpath1= "D:\\Sem6\\miniproject\\project\\DeepRetinopathy\\dbase\\"+ cls['image'].iloc[1] +".jpeg" 
    fpath2= "D:\\Sem6\\miniproject\\project\\DeepRetinopathy\\dbase\\"+ cls['image'].iloc[2] +".jpeg" 
    fpath3= "D:\\Sem6\\miniproject\\project\\DeepRetinopathy\\dbase\\"+ cls['image'].iloc[3] +".jpeg" 
...
def readfeatures(cls,K):
    ...
    for num,fname in enumerate(cls['image'],start=0):            
        hfc1[num,:]=hogfeatures2("D:\\Sem6\\miniproject\\project\\DeepRetinopathy\\dbase\\",fname)      
        hfc2[num,:]=dogfeatures2("D:\\Sem6\\miniproject\\project\\DeepRetinopathy\\dbase\\",fname)    
        if ( num+1 >= K ):
            break;
...
def predection():
    Labels = pd.read_csv('D:\\Sem6\\miniproject\\project\\DeepRetinopathy\\Labels.csv')
    ...
    xdata[0,0:63] =hogfeatures2("D:\\Sem6\\miniproject\\project\\DeepRetinopathy\\",fname)      
    xdata[0,63:126] =dogfeatures2("D:\\Sem6\\miniproject\\project\\DeepRetinopathy\\",fname)         
